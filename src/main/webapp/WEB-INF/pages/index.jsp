...
<body id="kt_body" style="background-image: url(images/backgrounds/background-white.jpg)" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
<!--begin::Main-->
<!--begin::Header Mobile-->
