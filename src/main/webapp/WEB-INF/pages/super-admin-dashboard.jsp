...
<decorator:decorate filename="template.jsp">
    <decorator:content placeholder="title">Super Admin Dashboard</decorator:content>
    <decorator:content placeholder="pagetitle">Super Admin Dashboard</decorator:content>
