...
<!--end::Head-->
<!--begin::Body-->
<body id="kt_body" style="background-image: url('/cdn/backgrounds/background-white.jpg');" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
<!--begin::Main-->
